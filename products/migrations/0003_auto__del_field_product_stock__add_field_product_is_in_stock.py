...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('products_product', 'stock')

        # Adding field 'Product.is_in_stock'
        db.add_column('products_product', 'is_in_stock',
    ...
    def backwards(self, orm):
        ...
        db.add_column('products_product', 'stock',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Product.is_in_stock'
        db.delete_column('products_product', 'is_in_stock')
