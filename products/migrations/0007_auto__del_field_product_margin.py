...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.margin'
        db.delete_column('products_product', 'margin')


    def backwards(self, orm):
        # Adding field 'Product.margin'
        db.add_column('products_product', 'margin',
                      self.gf('django.db.models.fields.DecimalField')(default=100.0, max_digits=10, decimal_places=2),
                      keep_default=False)
