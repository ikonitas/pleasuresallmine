...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('orders_order', 'delivery_price_id')

        # Adding field 'Order.delivery'
        db.add_column('orders_order', 'delivery',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['deliveries.Delivery']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Order.delivery_price'
        raise RuntimeError("Cannot reverse this migration. 'Order.delivery_price' and its values cannot be restored.")
        # Deleting field 'Order.delivery'
        db.delete_column('orders_order', 'delivery_id')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'delivery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['deliveries.Delivery']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
