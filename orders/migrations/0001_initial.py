...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_order', (
            ...
            ('transaction_id', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('payer_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('payer_full_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('delivery_price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deliveries.Delivery'])),
            ('payment_status', self.gf('django.db.models.fields.CharField')(default='Uncompleted', max_length=20, null=True, blank=True)),
            ('basket_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        ...
        # Adding model 'OrderNone'
        db.create_table('orders_ordernone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'])),
        ...
        db.send_create_signal('orders', ['OrderNone'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'OrderNone'
        db.delete_table('orders_ordernone')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'delivery_price': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['deliveries.Delivery']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
