...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderLine.color'
        db.add_column('orders_orderline', 'color',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Color'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrderLine.size'
        db.add_column('orders_orderline', 'size',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Size'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderLine.color'
        db.delete_column('orders_orderline', 'color_id')

        # Deleting field 'OrderLine.size'
        db.delete_column('orders_orderline', 'size_id')
