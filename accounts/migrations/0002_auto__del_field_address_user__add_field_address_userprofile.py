...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.userprofile'
        db.add_column('accounts_address', 'userprofile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['accounts.UserProfile']),
                      keep_default=False)
